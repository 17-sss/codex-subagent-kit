...
Install the legacy Python codex-subagent-kit app for development using a repo-local editable virtualenv.

Options:
  --python <bin>     Python executable to use (default: ${PYTHON_BIN})
  --venv-dir <path>  Virtualenv directory (default: ${VENV_DIR})
  --link-dir <path>  Directory for the optional codex-subagent-kit-legacy symlink (default: ${LINK_DIR})

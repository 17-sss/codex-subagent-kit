...
- [x] T001 Add a read-only role board renderer in `src/codex_subagent_kit/dashboard.py`.
- [x] T002 Add CLI surface in `src/codex_subagent_kit/cli.py` for rendering a role board.
...
- [x] T006 Add launcher script template/rendering logic in `src/codex_subagent_kit/launchers.py`.
- [x] T007 Extend project scaffold generation in `src/codex_subagent_kit/generator.py` to create launcher script seeds and backfill missing ones on rerun.

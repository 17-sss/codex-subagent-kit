...
### User Story 2 - Project installs preserve the root-orchestrator guardrail (Priority: P1)

기여자는 project install에서 root orchestrator가 없는 잘못된 선택을 방지하고 싶다.

**Independent Test**: TS 테스트가 기본 선택과 project-scope validation을 검증하면 된다.
...
- **FR-003**: System MUST keep the project-scope orchestrator requirement in the interactive flow.

...
TypeScript 마이그레이션은 stable product surface 기준으로 완료됐다. 이제 `codex-subagent-kit`는 [`packages/codex-subagent-kit/`](../packages/codex-subagent-kit/) 아래의 npm-oriented CLI로 배포된다.
...
- [packages/codex-subagent-kit/test/fixtures/golden](../packages/codex-subagent-kit/test/fixtures/golden)의 golden fixture
- [packages/codex-subagent-kit/test](../packages/codex-subagent-kit/test)에 고정된 CLI 동작
